...
func assets_client_page_html() ([]byte, error) {
	return bindata_read(
		"/mnt/e/golang/ngrok/assets/client/page.html",
...
func assets_client_static_css_bootstrap_min_css() ([]byte, error) {
	return bindata_read(
		"/mnt/e/golang/ngrok/assets/client/static/css/bootstrap.min.css",
...
func assets_client_static_css_highlight_min_css() ([]byte, error) {
	return bindata_read(
		"/mnt/e/golang/ngrok/assets/client/static/css/highlight.min.css",
...
func assets_client_static_img_glyphicons_halflings_png() ([]byte, error) {
	return bindata_read(
		"/mnt/e/golang/ngrok/assets/client/static/img/glyphicons-halflings.png",
...
func assets_client_static_js_angular_sanitize_min_js() ([]byte, error) {
	return bindata_read(
		"/mnt/e/golang/ngrok/assets/client/static/js/angular-sanitize.min.js",
...
func assets_client_static_js_angular_js() ([]byte, error) {
	return bindata_read(
		"/mnt/e/golang/ngrok/assets/client/static/js/angular.js",
...
func assets_client_static_js_base64_js() ([]byte, error) {
	return bindata_read(
		"/mnt/e/golang/ngrok/assets/client/static/js/base64.js",
...
func assets_client_static_js_highlight_min_js() ([]byte, error) {
	return bindata_read(
		"/mnt/e/golang/ngrok/assets/client/static/js/highlight.min.js",
...
func assets_client_static_js_jquery_1_9_1_min_js() ([]byte, error) {
	return bindata_read(
		"/mnt/e/golang/ngrok/assets/client/static/js/jquery-1.9.1.min.js",
...
func assets_client_static_js_jquery_timeago_js() ([]byte, error) {
	return bindata_read(
		"/mnt/e/golang/ngrok/assets/client/static/js/jquery.timeago.js",
...
func assets_client_static_js_ngrok_js() ([]byte, error) {
	return bindata_read(
		"/mnt/e/golang/ngrok/assets/client/static/js/ngrok.js",
...
func assets_client_static_js_vkbeautify_js() ([]byte, error) {
	return bindata_read(
		"/mnt/e/golang/ngrok/assets/client/static/js/vkbeautify.js",
...
func assets_client_tls_ngrokroot_crt() ([]byte, error) {
	return bindata_read(
		"/mnt/e/golang/ngrok/assets/client/tls/ngrokroot.crt",
...
func assets_client_tls_snakeoilca_crt() ([]byte, error) {
	return bindata_read(
		"/mnt/e/golang/ngrok/assets/client/tls/snakeoilca.crt",
